...
export function buildAp2RouteTable(adapter: PrestaShopAdapter, merchantSlug: string): RouteTable<RouteHandler> {
...
function checkoutWithMandate(adapter: PrestaShopAdapter, merchantSlug: string): RouteHandler {
  return async (req): Promise<RouteResponse> => {
